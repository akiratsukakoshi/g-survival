...
X, Y, S = 92, 204, 32
colors = {'#':'#596467', '.':'#fffdf7', '~':'#dac08a', '1':'#f6cf88', '2':'#b0dbcf', 'o':'#b4dce9', 'M':'#f4e7ad', 'S':'#227e67', 'G':'#e7b640', 'c':'#f1b5ac', 'g':'#ead0ad', 'y':'#d4bcdf'}
for c in range(14):
...
notes = [
 ...
 ('位置の指定', ['H02：スタート ／ B18：脱皮','ムカデ3体：赤線を通路沿いに往復。','D22〜J22・D26〜J26：ゲジ2体','D31・K35：ヤモリ2体 ／ L45：ゴール']),
