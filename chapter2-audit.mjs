...
try{
 ...
 await page.evaluate(()=>window.chapter2Test.setPosition(3,43));expect((await page.evaluate(()=>window.chapter2Test.snapshot())).sheltered,'passable gap did not shelter player');
